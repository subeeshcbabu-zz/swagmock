...
function mock(schema, useExample) {
    ...
    if (schema) {
        ...
        /**
         * Use examples as Mock if provided AND the user wants to use examples
         * else Get the mock generator from the `type` of the schema
         */
...
function objectMock(schema, useExample) {
    var mockObj = {};
    var props = schema.properties;
    if (props) {
        Object.keys(props).forEach(function (key) {
            mockObj[key] = mock(props[key], useExample);
        });
    /**
     ...
     */
        ...
        mockObj[Chance.word()] = mock(schema.additionalProperties, useExample);
    }
    return mockObj;
}
/**
 ...
 */
function arrayMock(schema, useExample) {
